...
<?php
						$mail = $_POST['email'];
						$to = "hannanazam200@gmail.com";/* YOUR EMAIL HERE */
						$subject = "Admission from KGS";
						$headers = "From: Admission from KGS <noreply@yourdomain.com>";
						$message = "DETAILS\n";
